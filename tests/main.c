...
int main(int argc, char **argv) {
    const struct CMUnitTest tests[] = {
        ...
        cmocka_unit_test(test_linked_list_destroy_nonempty_list_returns_success),
        ...
        cmocka_unit_test(test_linked_list_get_first_gives_null_and_fails_on_empty_list),
        ...
        cmocka_unit_test(test_linked_list_is_empty_gives_false_if_list_has_elements),
